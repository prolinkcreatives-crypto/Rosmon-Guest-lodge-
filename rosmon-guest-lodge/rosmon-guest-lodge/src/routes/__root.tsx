...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rosmon Guest Lodge — Chipata, Zambia" },
      {
        name: "description",
        content:
          "Comfortable, well-kept accommodation on David Kuanda Road, Chipata, Zambia.",
      },
...
function RootComponent() {
  ...
  // The staff admin panel has its own shell — no public navigation or footer.
