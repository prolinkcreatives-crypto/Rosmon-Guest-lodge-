      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-3">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              setDates({
                ...dates,
                checkIn,
                // Keep check-out valid (strictly after) instead of
                // silently leaving an equal-or-earlier date selected.
                checkOut: dates.checkOut && dates.checkOut > checkIn ? dates.checkOut : addDaysIso(checkIn, 1),
              });
            }}
        ...
        >
          <input
            ...
            type="date"
            required
            min={dates.checkIn ? addDaysIso(dates.checkIn, 1) : todayIso()}
