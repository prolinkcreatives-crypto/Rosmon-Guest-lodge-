...
function BlocksSection({ canManage }: { canManage: boolean }) {
  ...
  const [end, setEnd] = useState(addDaysIso(today, 1));
  ...
  return (
    <section className="mb-4">
      ...
      <p className="mb-3 text-xs text-muted-foreground">
        Blocks remove inventory from sale immediately — staff, calendar and the public
        booking flow all reflect them right away.
      </p>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setStart(value);
                  setEnd((prev) => (prev <= value ? addDaysIso(value, 1) : prev));
                }}
              />
            </div>
            <div>
