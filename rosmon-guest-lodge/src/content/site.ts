...
/**
 * SEO/canonical base URL. This is the Cloudflare Pages domain currently
 * serving the site (confirmed via a live WhatsApp preview, not guessed).
 * If a custom domain is bought and pointed at this deployment later,
 * update this one line — canonical tags, JSON-LD, and og:image all read
 * from it. public/robots.txt and public/sitemap.xml are static files and
 * hardcode this same domain separately; update those too at that point.
 */
export const siteUrl = "https://rosmon-guest-lodge.pages.dev";
