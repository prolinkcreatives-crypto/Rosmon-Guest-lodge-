...
/**
 * SEO/canonical base URL. No production domain exists anywhere in this
 * project (no env var, no wrangler/vite config, nothing hardcoded) —
 * this is a placeholder standing in for it, deliberately not a
 * real-looking domain so a missed replacement is obvious rather than
 * silently shipping a wrong canonical/sitemap/JSON-LD url. Replace with
 * the actual production domain (e.g. "https://www.rosmonguestlodge.com")
 * before relying on canonical tags, sitemap.xml, or structured data.
 */
export const siteUrl = "https://REPLACE-WITH-PRODUCTION-DOMAIN.example";
